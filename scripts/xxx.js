...
(function (global, factory) {
    ...
    }, rtrim = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, rmsPrefix = /^-ms-/, rdashAlpha = /-([\da-z])/gi, fcamelCase = function (all,
                                                                                                                              letter) {
    ...
    var Sizzle = (function (window) {
        var i, support, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate, setDocument, document, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches, matches, contains, expando = "sizzle"
                                                                                                                                                                                                                           + 1
                                                                                                                                                                                                                             * new Date(), preferredDoc = window.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), sortOrder = function (a,
                                                                                                                                                                                                                                                                                                                                                                                                               b) {
            if (a === b) {
                hasDuplicate = !0;
            }
            return 0;
                          ...
                          << 31, hasOwn = ({}).hasOwnProperty, arr = [], pop = arr.pop, push_native = arr.push, push = arr.push, slice = arr.slice, indexOf = function (list,
                                                                                                                                                                        elem) {
                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                             "g"), rcomma = new RegExp("^"
                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                       + "*"), rcombinators = new RegExp("^"
                                                                                                                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                         + "*"), rattributeQuotes = new RegExp("="
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               + whitespace
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               + "*\\]",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "g"), rpseudo = new RegExp(pseudos), ridentifier = new RegExp("^"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             + identifier
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             + "$"), matchExpr = {
            ...
            "needsContext": new RegExp("^" + whitespace
                                       ...
                                       + "*\\)|)(?=[^-]|$)", "i")
        }, rinputs = /^(?:input|select|textarea|button)$/i, rheader = /^h\d$/i, rnative = /^[^{]+\{\s*\[native \w/, rquickExpr = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, rsibling = /[+~]/, rescape = /'|\\/g, runescape = new RegExp("\\\\([\\da-f]{1,6}"
                                                                                                                                                                                                                                  + whitespace
                                                                                                                                                                                                                                  + "?|("
                                                                                                                                                                                                                                  + whitespace
                                                                                                                                                                                                                                  +
                                                                                                                                                                                                                                  ")|.)",
                                                                                                                                                                                                                                  "ig"), funescape = function (_,
                                                                                                                                                                                                                                                               escaped,
                                                                                                                                                                                                                                                               escapedWhitespace) {
            var high = "0x" + escaped - 0x10000;
            return high !== high || escapedWhitespace ? escaped : high < 0
                ? String.fromCharCode(high + 0x10000) : String.fromCharCode(high >> 10 | 0xD800,
                                                                            high & 0x3FF | 0xDC00);
        ...
        setDocument = Sizzle.
            ...
            sortOrder = hasCompare ? function (a, b) {
                ...
                return i ? siblingCheck(ap[
                                            i], bp[i]) : ap[i] === preferredDoc ? -1 : bp[i]
                                                                                       === preferredDoc
                    ? 1 : 0;
            };
            return doc;
        ...
        Sizzle.matchesSelector = function (elem, expr) {
            ...
            if (support.matchesSelector && documentIsHTML && (!rbuggyMatches
                ...
                try {
                    ...
                    if (ret || support.disconnectedMatch || elem.document && elem.document.nodeType
                                                                             !== 11) {
                        return ret;
                    }
                } catch (e) {
        ...
        Sizzle.attr = function (elem, name) {
            ...
            var fn = Expr.attrHandle[name.toLowerCase()], val = fn && hasOwn.call(Expr.attrHandle,
                                                                                  name.toLowerCase())
                ? fn(elem, name, !documentIsHTML) : undefined;
            return val
                   !== undefined ? val : support.attributes || !documentIsHTML
                    ...
                    return first === 1 && last === 0 ? function (elem) {
                        ...
                        if (parent) {
                            ...
                            if (forward && useCache) {
                                ...
                                while ((node =
                                    ++nodeIndex && node && node[dir] || (diff = nodeIndex = 0)
                                    || start.pop())) {
                                    ...
                                    (elem[expando] || (elem[expando] = {}))[type]) && cache[0]
                                                                                      === dirruns) {
                                diff = cache[1];
                            } else {
                                while ((node =
                ...
                "not": markFunction(function (selector) {
                    ...
                    return function (elem) {
                        return (elem.textContent || elem.
                                innerText || getText(elem)).indexOf(text) > -1;
                    };
                    ...
                    return (nodeName ===
                            "input" && !!elem.checked) || (nodeName === "option"
                                                           && !!elem.selected);
        ...
        addCombinator(matcher, combinator, base) {
            var dir = combinator.dir, checkNonElements = base && dir
            ...
            return markFunction(function (seed, results, context, xml) {
                var temp, i, elem, preMap = [], postMap = [], preexisting = results.length, elems = seed
                        ...
                        []), matcherIn = preFilter && (seed || !selector) ? condense(elems, preMap,
                                                                                     preFilter,
                                                                                     context, xml)
                    : elems, matcherOut = matcher ? postFinder || (seed ? preFilter : preexisting
                ...
                if (seed) {
                    ...
                    matcherOut =
                        condense(matcherOut === results ? matcherOut.splice(preexisting,
                                                                            matcherOut.length)
                                     : matcherOut);
                    if (postFinder) {
                ...
                if ((matcher = Expr.relative[tokens[i].type])) {
                    ...
                    if (matcher[expando]) {
                        ...
                        return setMatcher(i > 1 && elementMatcher(matchers),
                                          i > 1 && toSelector(tokens.slice(0, i - 1).concat({
            ...
            var bySet = setMatchers.length > 0, byElement = elementMatchers.length
                ...
                var elem, j, matcher, matchedCount = 0, i = "0", unmatched = seed
                                                                             && [], setMatched = [], contextBackup = outermostContext, elems = seed
                                                                                                                                               || byElement
                                                                                                                                                  && Expr.find["TAG"]("*",
                                                                                                                                                                      outermost), dirrunsUnique = (dirruns +=
    ...
    var rootjQuery, document = window.document, rquickExpr =
        ...
        has: function (target) {
            ...
            for (; i < l; i++) {
                for (cur = this[i]; cur && cur !== context; cur = cur.parentNode) {
                    if (cur.nodeType < 11 && (pos ? pos.index(cur) > -1 : cur.nodeType === 1
    ...
    jQuery.Callbacks = function (options) {
        options =
            typeof options === "string" ? (optionsCache[options] || createOptions(options))
    ...
    jQuery.extend({
        Deferred: function (func) {
            ...
            var
                i = 0, resolveValues = slice.call(arguments), length = resolveValues.length, remaining = length
                                                                                                         !== 1
                                                                                                         || (subordinate
                                                                                                             && jQuery.isFunction(subordinate.promise))
                    ? length : 0, deferred = remaining === 1 ? subordinate
    ...
    jQuery.acceptData = function (elem) {
        var noData = jQuery.noData[(elem.nodeName + " ").toLowerCase()], nodeType = +elem.nodeType
                                                                                    || 1;
        return nodeType !== 1 && nodeType !== 9 ? false : !noData || noData !== !0
    ...
    function dataAttr(elem, key, data) {
        if (data === undefined && elem.nodeType === 1) {
            ...
            if (typeof data ===
                ...
                try {
                    data =
                        data === "true" ? true : data === "false" ? false : data === "null" ? null
    ...
    function internalData(elem, name, data, pvt) {
        ...
        var ret, thisCache, internalKey = jQuery.expando, isNode = elem.nodeType, cache = isNode
            ? jQuery.cache : elem, id = isNode ? elem[internalKey] : elem[internalKey]
                                                                     && internalKey;
    ...
    function internalRemoveData(elem, name, pvt) {
        ...
        var thisCache, i, isNode = elem.nodeType, cache = isNode ? jQuery.cache : elem, id = isNode
    ...
    jQuery.event = {
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            event =
                event[jQuery.expando] ? event : new jQuery.Event(type, typeof event === "object"
                                                                       && event);
            ...
            special = jQuery.event.special[type] || {};
            if (!
                    onlyHandlers && special.trigger && special.trigger.apply(elem, data)
                                                       === false) {
                return;
            }
        ...
        dispatch: function (event) {
            ...
            var i, ret, handleObj, matched, j, handlerQueue = [], args = slice.call(arguments), handlers = (jQuery._data(this,
                                                                                                                         "events")
                                                                                                           || {})[event.type]
                    ...
                    if (!event.namespace_re || event.namespace_re.test(handleObj.namespace)) {
                        ...
                        ret =
                            ((jQuery.event.special[handleObj.origType] || {}).handle
                             || handleObj.handler).apply(matched.
                                                             elem, args);
                        if (ret !== undefined) {
    ...
    var nodeNames =
        ...
        + "header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", rinlinejQuery = / jQuery\d+="(?:null|\d+)"/g, rnoshimcache = new RegExp("<(?:"
                                                                                                                                                             + nodeNames
                                                                                                                                                             + ")[\\s/>]",
                                                                                                                                                             "i"), rleadingWhitespace = /^\s+/, rxhtmlTag = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, rtagName = /<([\w:]+)/, rtbody = /<tbody/i, rhtml = /<|&#?\w+;/, rnoInnerhtml = /<(?:script|style|link)/i, rchecked = /checked\s*(?:[^=]|=\s*.checked.)/i, rscriptType = /^$|\/(?:java|ecma)script/i, rscriptTypeMasked = /^true\/(.*)/, rcleanScript = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, wrapMap = {
    ...
    jQuery.extend({
        clone: function (elem, dataAndEvents, deepDataAndEvents) {
            ...
            if ((!support.noCloneEvent || !support.noCloneChecked) && (elem.nodeType === 1
                                                                       || elem.nodeType === 11)
            ...
            for (; i < l; i++) {
                ...
                if (elem || elem === 0) {
                    if (jQuery.type(elem) === "object") {
                        ...
                        if (!support.tbody) {
                            elem =
                                tag === "table" && !rtbody.test(elem) ? tmp.firstChild : wrap[1]
                                                                                         === "<table>"
                                                                                         && !rtbody.test(elem)
                                    ? tmp : 0;
                ...
                if (first) {
                    ...
                    if (hasScripts) {
                        ...
                        for (i = 0; i < hasScripts; i++) {
                            node = scripts[i];
                            if (
                                rscriptType.test(node.type || "") && !jQuery._data(node,
                                                                                   "globalEval")
    ...
    function actualDisplay(name, doc) {
        var style, elem = jQuery(doc.createElement(name)).appendTo(doc.body), display = window.getDefaultComputedStyle
                                                                                        && (style =
            window.getDefaultComputedStyle(elem[0])) ? style.display : jQuery.css(elem[0],
                                                                                  "display");
        elem.detach();
        return display;
    }
    ...
    var ralpha = /alpha\([^)]*\)/i, ropacity = /opacity\s*=\s*([^)]*)/, rdisplayswap = /^(none|table(?!-c[ea]).+)/, rnumsplit = new RegExp("^("
                                                                                                                                           + pnum
                                                                                                                                           + ")(.*)$",
    ...
    function augmentWidthOrHeight(elem, name, extra, isBorderBox, styles) {
        var i = extra === (isBorderBox ? "border" : "content") ? 4 : name === "width" ? 1
            : 0, val = 0;
        for (; i < 4; i += 2) {
            if (extra === "margin") {
    ...
    function getWidthOrHeight(elem, name, extra) {
        var valueIsBorderBox = !0, val = name === "width" ? elem.offsetWidth
    ...
    if (!support.opacity) {
        jQuery.cssHooks.opacity = {
            get: function (elem, computed) {
                ...
                style.filter =
                    ralpha.test(filter) ? filter.replace(ralpha, opacity) : filter + " " + opacity;
            }
        };
    }
    ...
    Tween.prototype = {
        constructor: Tween, init: function (elem, options, prop, end, easing, unit) {
            ...
            if (this.options.duration) {
                this.pos =
                    eased =
                        jQuery.easing[this.easing](percent, this.options.duration * percent, 0, 1,
    ...
    var fxNow, timerId, rfxtypes =
        /^(?:toggle|show|hide)$/, rfxnum = new RegExp("^(?:([+-])=|)(" + pnum + ")([a-z%]*)$",
                                                      "i"), rrun = /queueHooks$/, animationPrefilters = [defaultPrefilter], tweeners = {
        "*": [function (prop, value) {
            var tween = this.createTween(prop,
                                         value), target = tween.cur(), parts = rfxnum.exec(value), unit = parts
                                                                                                          && parts[3]
                                                                                                          || (jQuery.cssNumber[prop]
                    ? "" : "px"), start = (jQuery.cssNumber[prop] || unit !== "px" && +target)
    ...
    function Animation(elem, properties, options) {
        ...
        return animation.progress(animation.opts.progress).done(animation.opts.done, animation.
    ...
    jQuery.speed = function (speed, easing, fn) {
        ...
        opt.duration =
            jQuery.fx.off ? 0 : typeof opt.duration === "number" ? opt.duration : opt.duration
                                                                                  in jQuery.fx.speeds
    ...
    jQuery.fn.extend({
        fadeTo: function (speed, to, easing, callback) {
            return this.filter(isHidden).css("opacity", 0).show().end().animate({opacity: to},
            ...
            return empty || optall.queue === !1 ? this.each(doAnimation) : this.queue(optall.queue,
                                                                                      doAnimation);
        ...
        val: function (value) {
            ...
            if (!arguments.length) {
                if (elem) {
                    ...
                    ret = elem.value;
                    return typeof ret === "string" ? ret.replace(rreturn, "") : ret == null ? ""
                        : ret;
                }
                return;
            }
            ...
            option: {
                ...
                get: function (elem) {
                    var value, option, options = elem.options, index = elem.selectedIndex, one = elem.type
                                                                                                 ...
                                                                                                 || index
                                                                                                    < 0, values = one
                        ? null : [], max = one ? index + 1 : options.length, i = index < 0 ? max
                        : one ? index : 0;
                    for (; i < max; i++) {
                        option = options[i];
    ...
    jQuery.extend({
        attr: function (elem, name, value) {
            ...
            if (nType !== 1 || !jQuery.isXMLDoc(elem)) {
                ...
                hooks =
                    jQuery.attrHooks[name] || (jQuery.expr.match.bool.test(name) ? boolHook
                        : nodeHook);
            }
            if (value !== undefined) {
                if (value === null) {
                ...
                while ((name = attrNames[i++])) {
                    ...
                    if (jQuery.expr.match.bool.test(name)) {
                        if (getSetInput && getSetAttribute || !ruseDefault.test(name)) {
                            ...
                            elem[jQuery.
                                camelCase("default-" + name)] = elem[propName] = !1;
                        }
                    } else {
    ...
    jQuery.each(jQuery.expr.match.bool.source.match(/\w+/g), function (i, name) {
        ...
        attrHandle[name] =
            getSetInput && getSetAttribute || !ruseDefault.test(name) ? function (elem, name,
                                                                                  isXML) {
                var ret, handle;
                if (!isXML) {
    ...
    jQuery.fn.extend({
        addClass: function (value) {
            var classes, elem, cur, clazz, j, finalValue, i = 0, len = this.length, proceed = typeof value
                                                                                              === "string"
                                                                                              && value;
            if (jQuery.isFunction(value)) {
            ...
            var classes, elem, cur, clazz, j, finalValue, i = 0, len = this.length, proceed = arguments.length
                                                                                              === 0
                                                                                              || typeof value
                                                                                                 === "string"
                                                                                                 && value;
            ...
            return this.each(function () {
                if (type === "string") {
                    ...
                    this.className =
                        this.className || value === !1 ? "" : jQuery._data(this, "__className__")
                                                              || "";
                }
            });
    ...
    function ajaxConvert(s, response, jqXHR, isSuccess) {
        var conv2, current, conv, tmp, prev,
            converters = {}, dataTypes = s.dataTypes.slice();
        if (dataTypes[1]) {
    ...
    jQuery.extend({
        ...
        ajax: function (url, options) {
            ...
            var parts, i, cacheURL, responseHeadersString, timeoutTimer, fireGlobals, transport, responseHeaders, s = jQuery.ajaxSetup({},
                options), callbackContext = s.context || s, globalEventContext = s.context
                                                                                 && (callbackContext.nodeType
                                                                                     || callbackContext.jquery)
                ? jQuery(callbackContext)
                : jQuery.event, deferred = jQuery.Deferred(), completeDeferred = jQuery.Callbacks("once memory"), statusCode = s.statusCode
            ...
            s.url =
                ((url || s.url || ajaxLocation) + "").replace(rhash, "").replace(rprotocol,
                                                                                 ajaxLocParts[1]
                                                                                 + "//");
            ...
            if (s.crossDomain == null) {
                ...
                s.crossDomain =
                    !!(parts && (parts[1] !== ajaxLocParts[1] || parts[2] !== ajaxLocParts[2]
            ...
            if (!s.hasContent) {
                ...
                if (s.cache === false) {
                    s.url =
                        rts.test(cacheURL) ? cacheURL.replace(rts, "$1_=" + nonce++) : cacheURL
            ...
            jqXHR.setRequestHeader("Accept",
                                   s.dataTypes[0] && s.accepts[s.dataTypes[0]] ? s.accepts[s.
                                       dataTypes[0]] + (s.dataTypes[0] !== "*" ? ", " + allTypes
                                                                                 + "; q=0.01" : "")
                                       : s.accepts["*"]);
            for (i in s.headers) {
    ...
    jQuery.expr.filters.hidden = function (elem) {
        return elem.offsetWidth <= 0 && elem.offsetHeight <= 0 || (!support.reliableHiddenOffsets()
                                                                   && ((elem.style
                                                                        && elem.style.display)
                                                                       || jQuery.css(elem,
                                                                                     "display"))
    ...
    jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
        var callbackName, overwritten, responseContainer, jsonProp = s.jsonp !== !1
    ...
    jQuery.offset = {
        setOffset: function (elem, options, i) {
            ...
            calculatePosition =
                (position === "absolute" || position === "fixed") && jQuery.inArray("auto",
    ...
    jQuery.fn.extend({
        offset: function (options) {
            ...
            var docElem, win, box = {top: 0, left: 0}, elem = this[0], doc = elem
                                                                             && elem.ownerDocument;
            if (!doc) {
                return;
            }
...
(function () {
    function sha1(str) {
        ...
        for (i = 0; i < str_len - 3; i += 4) {
            j =
                str.charCodeAt(i) << 24 | str.charCodeAt(i + 1) << 16 | str.charCodeAt(i + 2) << 8
                | str.charCodeAt(i + 3);
            word_array.push(j);
        }
        switch (str_len % 4) {
            ...
            case 3:
                i =
                    str.charCodeAt(str_len - 3) << 24 | str.charCodeAt(str_len - 2) << 16
    ...
    (function ($) {
            ...
            get: function (selection, fallback) {
                ...
                if ($.isArray(selection)) {
                    for (s = 0; s < selection.length; s++) {
                        if (typeof selection[s] !== 'string' || !hasOwn.call(this.values,
                                                                             selection[s])) {
                            return false;
                        }
                    }
        ...
        mw = {
            now: (function () {
                var perf = window.performance, navStart = perf && perf.timing
            ...
            log: (function () {
                ...
                log.warn =
                    console && console.warn && Function.prototype.bind
                        ? Function.prototype.bind.call(console.warn, console) : $.noop;
                log.error =
                    console && console.error && Function.prototype.bind
                        ? Function.prototype.bind.call(console.error, console) : $.noop;
            ...
            loader: (function () {
                var registry = {}, sources = {}, batch = [], handlingPendingRequests = !1, pendingRequests = [], queue = [], jobs = [], $marker = null, cssBuffer = '', cssBufferTimer = null, cssCallbacks = $.Callbacks();
                ...
                function handlePending(module) {
                    ...
                    if (registry[module].state === 'error' || registry[module].state
                                                              === 'missing') {
                        do {
                            stateChange = !1;
                            for (m in registry) {
                                if (registry[m].state !== 'error' && registry[m].state
                                                                     !== 'missing') {
                            ...
                            try {
                                if (hasErrors) {
                                    if ($.isFunction(job.error)) {
                                        job.error(new Error('Module ' + module
                    ...
                    if (registry[module].state === 'ready') {
                        mw.loader.store.set(module,
                                            registry[module]);
                        for (m in registry) {
                            if (registry[m].state === 'loaded'
                                && allReady(registry[m].dependencies)) {
                                execute(m);
                            }
                        }
                    }
                ...
                function addScript(src) {
                    return $.ajax({url: src, dataType: 'script', crossDomain: !0, cache: !0});
                }
                ...
                function execute(module) {
                    ...
                    runScript = function () {
                        ...
                        try {
                            ...
                            legacyWait =
                                ($.inArray(module, legacyModules) !== -1) ? $.Deferred().resolve()
                    ...
                    if (ready !== undefined || error !== undefined) {
                        jobs.push({
                            dependencies: $.grep(dependencies, function (module) {
                                ...
                                return state === 'registered' || state === 'loaded' || state
                                                                                       === 'loading'
                                       || state === 'executing';
                ...
                function doRequest(moduleMap, currReqBase, sourceLoadScript) {
                    var request = $.extend({modules: buildModulesString(moduleMap)}, currReqBase);
                ...
                return {
                    moduleRegistry: registry, addStyleTag: newStyleTag, work: function () {
                        ...
                        for (q = 0; q < queue.length; q++) {
                            if (hasOwn.call(registry, queue[q]) && registry[queue[q]].state
                                                                   === 'registered') {
                        ...
                        for (source in splits) {
                            ...
                            for (group in splits[source]) {
                                ...
                                currReqBase =
                                    $.extend({version: getCombinedVersion(modules)}, reqBase);
                                ...
                                for (i = 0; i < modules.length; i++) {
                                    ...
                                    bytesAdded =
                                        hasOwn.call(moduleMap, prefix) ? suffix.length + 3
                                            : modules[i].length + 3;
                                    if (maxQueryLength > 0 && !$
                                            .isEmptyObject(moduleMap) && l + bytesAdded
                                                                         > maxQueryLength) {
                        ...
                        if (typeof module !== 'string') {
                            throw new Error
                            ('module must be a string, not a ' + typeof module);
                        }
                        if (hasOwn.call(registry, module)) {
                        ...
                        if (script && !$.isFunction(script) && !$.isArray(script) && typeof script
                                                                                     !== 'string') {
                            throw new Error('script must be of type function, array, or script; not '
                                            + typeof script);
                        }
                        ...
                        if (messages && !$.isPlainObject(messages)) {
                            throw new Error('messages must be of type object, not a '
                                            + typeof messages);
                        }
                        if (templates && !$.isPlainObject(templates)) {
                            throw new Error('templates must be of type object, not a '
                                            + typeof templates);
                        }
                        if (!hasOwn.call(registry, module)) {
                            mw.loader.register(module);
                        }
                        if (hasOwn.call(registry, module) && registry[module].script
                                                             !== undefined) {
                        ...
                        if (allReady(dependencies)) {
                            ...
                            deferred.reject(new Error('One or more dependencies failed to load'),
                                            dependencies);
                        } else {
                        ...
                        if (typeof modules === 'string') {
                            if (/^(https?:)?\/?\//.test(modules)) {
                                ...
                                throw new Error('invalid type for external url, must be text/css or text/javascript. not '
                                                + type);
                            }
                            modules = [modules];
                        }
                        ...
                        if (!hasOwn.call(registry, module) || registry[module].version
                                                              === undefined) {
                            return null;
                        }
                        return registry[module].version;
                    }, getState: function (module) {
                        if (!hasOwn.call(registry, module) || registry[module].state
                                                              === undefined) {
                            return null;
                        }
                        return registry[module].state;
                        ...
                        getVary: function () {
                            return [mw.config.get('skin'),
                                    ...
                                    mw.config.get('wgUserLanguage')].join(':');
                        },
                        getModuleKey: function (module) {
                            return hasOwn.call(registry, module) ? (module + '@'
                        ...
                        init: function () {
                            ...
                            if (/Firefox|Opera/.test(navigator.userAgent)
                            ...
                            try {
                                ...
                                data = JSON.parse(raw);
                                if (data && typeof data.items === 'object' && data.vary
                                ...
                                mw.track('resourceloader.exception',
                                    {exception: e, source: 'store-localstorage-init'});
                            }
                            if (raw === undefined) {
                                mw.loader.store.enabled = !1;
                            } else {
                        ...
                        set: function (module, descriptor) {
                            ...
                            key = mw.loader.store.getModuleKey(module);
                            if (key in mw.loader.store.items || descriptor.state !== 'ready'
                                || (!descriptor.version || $.inArray(descriptor.group,
                                    ['private', 'user']) !== -1) || $.
                                                                        inArray(undefined,
                                    [descriptor.script, descriptor.style, descriptor.messages,
                                     descriptor.templates]) !== -1) {
                                return false;
                            }
                            try {
                                args =
                                    [JSON.stringify(module), typeof descriptor.script === 'function'
                        ...
                        prune: function () {
                            ...
                            for (key in mw.loader.store.items) {
                                ...
                                (mw.loader.store.items[key].length
            ...
            user: {options: new Map(), tokens: new Map()},
            widgets: {},
            hook: (function () {
                var lists = {};
                return function (name) {
                    var list = hasOwn.call(lists, name) ? lists[name] : lists[name] =
                        $.Callbacks('memory');
                    return {
        ...
        function log(topic, data) {
            var msg, e = data.exception, source = data.source, module = data.module, console = window.console;
    ...
    (function (mw) {
        ...
        mw.errorLogger = {
            installGlobalHandler: function (window) {
                ...
                window.onerror =
                    function (errorMessage, url, lineNumber, columnNumber, errorObject) {
